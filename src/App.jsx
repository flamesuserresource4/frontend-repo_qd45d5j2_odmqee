...
function App() {
  return (
    <div className="min-h-screen bg-[#0c0a08] text-amber-50 relative">
      {/* Brighter sandy starfield haze */}
      <div className="pointer-events-none absolute inset-0 [background:radial-gradient(110%_80%_at_50%_-10%,rgba(245,158,11,0.10),transparent),radial-gradient(circle_at_20%_30%,rgba(255,255,255,0.06),transparent_20%),radial-gradient(circle_at_80%_20%,rgba(255,255,255,0.05),transparent_22%),radial-gradient(circle_at_60%_70%,rgba(253,230,138,0.05),transparent_18%)]" />
      ...
      <section id="contact" className="relative py-20">
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center">
          ...
          <form className="mt-8 grid gap-4 text-left">
            ...
            <textarea name="project" rows="4" placeholder="What are you trying to build?" className="w-full rounded-md border border-amber-400/20 bg-stone-900/60 px-4 py-3 text-amber-100 placeholder-amber-200/40 focus:outline-none focus:ring-2 focus:ring-amber-400/50" />
            <div className="flex items-center justify-center">
              <button type="button" className="inline-flex items-center justify-center rounded-md bg-amber-500 px-6 py-3 font-semibold text-stone-900 shadow hover:bg-amber-400 transition">
                Send transmission
              </button>
            </div>
          </form>
